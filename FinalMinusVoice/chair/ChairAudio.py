...
def switchContent():
	...
	pygame.mixer.music.load("/home/pi/Desktop/chair/data/ClickButton.mp3")
...
while True:
	...
	if data != "":
		if data == "contentUp" :	# Switch to the next layer of content
			if contentHasUpdatedRecently == False:
				switchContent()
	...
	idleTimer += time.time() - lastTime
	if userHere == False and idleTimer > 30:
		playIdleAudio()
		nextIdleSpeak += 1
		idleTimer = 0
	...
	if userHere == True and timeSinceUserDetected > 15:
		userHere = False
		idleTimer =30
